...
function SideBar() {
  return (
    <div className="relative w-1/6 h-full bg-purple-700 border-r-2 border-violet-300 flex flex-col select-none">
        <div className="logoContainer w-full h-40 flex justify-center items-center">
            <img src={tLogo} alt="app logo" className="w-auto h-full"></img>
        </div>
        <ChatList />
        <div className="absolute bottom-0 w-full h-16 border-t-2 border-violet-400">
            <div className='w-full h-full flex items-center mx-4'>
                <div className="relative w-12 h-12">
                    <img src={pPhoto} alt="profile pic" className="rounded"></img>
